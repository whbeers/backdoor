...
This is my take on the ProCo "Rat" distortion, designed in [KiCAD](https://www.kicad.org/).  The design is initially based on widely available schematics, but tweaked while building it out on a breadboard with my daughter. (She was involved in every stage of the development of this effect, and learned a ton!)
